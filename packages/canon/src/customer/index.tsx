...
import { Mono, Card, Checkbox, IconArrow } from '../primitives';
...
// ── #9 Feedback form REMOVED in 0.13.0 ─────────────────────
// Vote-first S9_FeedbackModal (+ FbTally/FbVote/FbSubmitPayload/FbKind/
// S9_FeedbackModalProps + aliases S9_FeedbackPage/FeedbackPage) deleted as a
// breaking change. Replaced by @samosite/canon/feedback (FeedbackV2Modal,
// mode="blocker"|"question"). See CHANGELOG 0.13.0.
