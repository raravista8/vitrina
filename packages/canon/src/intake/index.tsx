...
import { Mono, Btn, Checkbox, IconLink, IconArrow, Spinner, BrandMark } from '../primitives';
...
const SubmitModal = S3_SubmitModal;
const Confirmation = S5_Confirmation;
const PhotoDrawer = S6_PhotoDrawer;
