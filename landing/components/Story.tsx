...
const STEPS = [
  {
    n: 1,
    title: "Дайте ссылку на ваше дело",
  ...
  {
    n: 3,
    title: "Сайт появится на своём адресе",
    body: "На <ваш-сайт>.samosite.online или подключите свой домен. Защищённый https, индексация в Яндексе и Google — из коробки.",
    bg: "oklch(0.94 0.05 200)",
    ink: "oklch(0.34 0.10 220)",
  },
  {
    n: 4,
    title: "Сам обновляется — или вы добавляете",
    body: "Раз в неделю забирает свежие посты из источника. А если выкатили новую услугу — просто пришлите фото и текст в личном кабинете, сайт обновится.",
    bg: "oklch(0.94 0.05 145)",
    ink: "oklch(0.32 0.11 145)",
  },
  {
    n: 5,
    title: "Заявки летят к вам в мессенджер",
  ...
  return (
    ...
    >
      <header className="mx-auto mb-10 max-w-[1100px] sm:mb-16 sm:text-center">
        ...
        >
          Шесть шагов — и сайт работает сам
        </h2>
      </header>
      ...
      <ol className="mx-auto flex max-w-[1100px] flex-col gap-7 sm:gap-12">
        {STEPS.map((s, idx) => {
          ...
          return (
            ...
            >
              <div
                className="relative rounded-[24px] border-[2px] border-ink p-6 sm:p-8"
