...
// canon 0.7.1 microcopy under CTA — synced to the new 5-tier pricing model.
// Was «990 ₽/мес · для первой сотни 490 ₽ навсегда» (single-plan model); canon
// 0.7.1 replaced the single price with a 5-plan PricingMatrix (Старт 0 ₽ /
// Личный 690 / Бизнес 1490 / Компания 2990 / Студия 6990). This microcopy now
// matches canon's hero line + the matrix below, so the same page no longer
// contradicts itself. Backend ЮKassa is still single-plan 990 ₽ — the 5-tier
// model is frontend-only until backend pricing ships (see
// docs/handoff/CANON_SWAP_PLAN.md §«Pricing model»).
const CTA_MICROCOPY =
  "Тариф «Старт» — бесплатно навсегда · платные от 690 ₽/мес · первый месяц на платном бесплатно, карту привязывать не надо";
