...
export const metadata: Metadata = {
  ...
  description:
    "Как Самосайт обрабатывает персональные данные мастеров и конечных посетителей сайтов согласно ФЗ-152.",
    ...
    <>
      <main className="mx-auto max-w-3xl px-6 py-20 text-base text-neutral-700">
        ...
        <section className="mt-10 space-y-4">
          ...
          <p>
            Оператор персональных данных — ИП «Самосайт», сайт{" "}
          ...
          <p>
            ...
            Доступ к расшифрованным данным имеет ИП «Самосайт» и владелец конкретного сайта; каждая
