...
const SEO_KEYWORDS = [
  ...
  // Generic / search-intent (added per founder request — high-volume queries).
  // NB: <meta keywords> has ~no Google ranking weight; the real levers are
  // title / H1 / description / JSON-LD (already set). Kept for Яндекс +
  // completeness. Near-duplicates of the entries above are omitted.
  "конструктор сайтов",
  "бесплатный конструктор сайтов",
  "конструктор сайтов для бизнеса",
  "конструктор лендингов",
  "ии конструктор сайтов",
  "создать сайт",
  "создать сайт самому",
  "создать сайт по фото",
  "создать сайт с помощью нейросети",
  "сделать сайт",
  "сделать сайт онлайн",
  "сделать сайт быстро",
  "сделать сайт недорого",
  "сделать сайт из инстаграма",
  "сайт визитка",
  "сайт под ключ недорого",
  "сайт для самозанятого",
  "сайт для ИП",
  "сайт на нейросети",
  "сайт из телеграм канала",
