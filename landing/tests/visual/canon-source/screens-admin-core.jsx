// Screens #10 #11 #12 #13 · Admin core (login, dashboard, apps list, app detail)
// Concept A · "Тёплая бумага" — admin chrome uses bgSoft as canvas, white cards.

if (!window.__vt_admin1) { window.__vt_admin1 = true; (function vtAdmin1(){

const VT = window.VT;
const { Eyebrow, Mono, Card, Btn, Input, Badge, Checkbox, IconLink, IconArrow, Spinner } = window;
...
Object.assign(window, { S10_AdminLogin, S11_Dashboard, S12_AppsList, S13_AppDetail, AdminChrome, StatusPill, StatTile });

})(); } // end __vt_admin1 guard
