// Screen #2 · Source detection states (badge under Hero input)
// Concept A "Тёплая бумага" palette. Renders a catalog of every state.

if (!window.__vt_s2) { window.__vt_s2 = true; (function vtS2(){

const VT = window.VT;
const { Eyebrow, Mono, Card, Btn, Input, Badge, IconLink, IconArrow, Spinner } = window;
...
Object.assign(window, { S2_Desktop, S2_Mobile });
