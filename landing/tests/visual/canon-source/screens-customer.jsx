// Screens #7 #8 #9 · Customer-side + feedback
// #7 is the customer-facing template (Jinja2 + Tailwind CDN per spec), here
// rendered as a mock React preview. The actual Jinja2 template lives in /code.

if (!window.__vt_cust) { window.__vt_cust = true; (function vtCust(){
...
Object.assign(window, { S7_CustomerSite, S7_SchemeSwatches, S8_LeadFormConfirm, S9_FeedbackPage });
